...
1. **Register** at: https://geo-prompt-monitor.preview.emergentagent.com/auth/register
...
```bash
# Using email
curl "https://geo-prompt-monitor.preview.emergentagent.com/api/auth/dev/get-otp/john@example.com"

# OR using phone
curl "https://geo-prompt-monitor.preview.emergentagent.com/api/auth/dev/get-otp/%2B1234567890"
```
...
1. **Go to Registration**
   - Visit: https://geo-prompt-monitor.preview.emergentagent.com/auth/register
...
6. **Login**
   - Visit: https://geo-prompt-monitor.preview.emergentagent.com/auth/login
...
curl -s -X POST https://geo-prompt-monitor.preview.emergentagent.com/api/auth/register \
  -H "Content-Type: application/json" \
  -d '{
    "first_name": "Test",
    "last_name": "User",
...
echo -e "\n2. Getting OTP codes..."
sleep 2
OTP_RESPONSE=$(curl -s "https://geo-prompt-monitor.preview.emergentagent.com/api/auth/dev/get-otp/test123@example.com")
...
curl -s -X POST https://geo-prompt-monitor.preview.emergentagent.com/api/auth/verify-otp \
  -H "Content-Type: application/json" \
  -d "{
...
echo -e "\n5. Logging in..."
curl -s -X POST https://geo-prompt-monitor.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{
    "identifier": "test123@example.com",
    "password": "Test@123456"
